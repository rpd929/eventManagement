...
public class bookEvent extends javax.swing.JFrame {
    ...
    public bookEvent(User loggedIn, Event event)
    {
        ...
        selectedEventLabel.setText(selectedEvent.seeMore());
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(37, 37, 37)
                        .addComponent(selectedEventLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 305, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(selectedEventLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(EventBooking.checkStrings(bookerName) && EventBooking.checkEmail(email))
        {
            this.dispose();
            checkBooking(bookerName, email, numberOfTickets);
    ...
    public static boolean checkBooking(String name, String email, int bookingAmount)
    {
        if(EventBooking.checkStrings(name) && EventBooking.checkEmail(email) && selectedEvent.checkCapacity(bookingAmount))
        {
            ...
            for(int x = 0; x < bookingAmount;x++)
            {
                ...
                {
                    EventBooking.currentUser.bookEvent(allEvents.findEvent(selectedEvent.eventID));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(discount != -1)
        {
            ...
            newPrice = newPrice *(1-discount);
            priceLabel.setText("<html><b>Promotional Code Price: $</b>" + newPrice +  "</html>");
            discountCode = code;
