...
public class changeEvent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nameField.setForeground(new java.awt.Color(0, 71, 187));
        ...
        priceField.setForeground(new java.awt.Color(0, 71, 187));

        capacityField.setText(Integer.toString(allEvents.allEvents.get(indexEvent).getCapacity()));
        capacityField.setForeground(new java.awt.Color(0, 71, 187));

        locationField.setText(allEvents.allEvents.get(indexEvent).getLocation());
        locationField.setForeground(new java.awt.Color(0, 71, 187));
        ...
        jScrollPane1.setForeground(new java.awt.Color(0, 71, 187));
        ...
        emailField.setForeground(new java.awt.Color(0, 71, 187));
